...
class Vivienda extends Model
{
    ...
    /*public function vivienda_condiciones()
    {
        return $this->hasOne(Vivienda_condiciones::class, 'vivienda_id', 'id');
    }

    public function vivienda_eseneres()
    {
        return $this->hasOne(Vivienda_eseneres::class, 'vivienda_id', 'id');
    }

    public function vivienda_servicios_comunidad()
    {
        return $this->hasOne(Vivienda_servicios_comunidad::class, 'vivienda_id', 'id');
    }

    public function vivienda_servicios_publicos()
    {
        return $this->hasOne(Vivienda_servicios_publicos::class, 'vivienda_id', 'id');
    } */
}
